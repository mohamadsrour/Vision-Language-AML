...
class DomainDisentangleDGExperiment:
    ...
    def train_iteration(self, data):
        ...
        tot_loss = (0.4 * src_loss_class) + (0.09 * src_loss_domain) + (0.02 * src_loss_rec) + (0.4 * src_loss_class_ent) + (0.09 * src_loss_domain_ent)
